...
const Hero = () => {
  ...
  return (
    <div className='w-full h-[450px] lg:h-[580px]'>
      <div className="w-full h-full">
        <div className='absolute w-full h-[450px] lg:h-[580px] bg-gradient-to-r from-black' />
        <img
          className='w-full h-full object-cover object-top'
          src={createImageUrl(backdrop_path,'original')} alt={title} />

        <div className='absolute w-full top-[35%] lg:top-[45%] p-4 md:p-8'>
